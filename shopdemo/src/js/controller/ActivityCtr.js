...
export const ActivityCtr = {
    ...
    getPageActivities: (param = {start: 1, limit: 10}, refresh) => {
        ...
        // param.orderColumn = ""
        // param.orderDir = "desc";
        return Ajax.get("802755", param, refresh);
    },
    // 获取活动详情
    ...
    getPageShop:(param = {start: 1, limit: 10}, refresh) => {
        //param.applyUser = Util.getUserId();
        return Ajax.get("808025", param, refresh);
    },
    getPageTake:(param = {start: 1, limit: 10}, refresh) => {
        param.applyUser = Util.getUserId();
        return Ajax.get("802755", param, refresh);
    },
    getPageGet:(param = {start: 1, limit: 10,storeCode}, refresh) => {
        //param.storeCode = storeCode;
        return Ajax.get("808065", param, refresh);
    },
};
