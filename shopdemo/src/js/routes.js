...
const PayMoney = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/PayMoney').default)
    }, 'PayMoney');
};
...
const ShopList = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/ShopList').default)
    }, 'ShopList');
};
const TakeList = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/TakeList').default)
    }, 'TakeList');
};
const GetList = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/GetList').default)
    }, 'GetList');
};
const EditBank = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/EditBank').default)
    }, 'EditBank');
};
const CatBank = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/User/CatBank').default)
    }, 'CatBank');
};
export default(
    <Route path="/" component={App}>
        ...
        <Route path="user">
            ...
            <Route path="paymoney" getComponent={PayMoney}/>
            <Route path="EditBank" getComponent={EditBank}/>
            <Route path="CatBank" getComponent={CatBank}/>
            <Route path="shoplist" getComponent={ShopList}/>
            <Route path="takelist" getComponent={TakeList}/>
            <Route path="getlist" getComponent={GetList}/>
