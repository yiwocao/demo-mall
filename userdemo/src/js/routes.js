...
const CommodityListtype = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/CommodityListtype').default)
    }, 'CommodityList');
};
const CommodityDetailtype = (location, cb) => {
    require.ensure([], require => {
        cb(null, require('./components/CommodityListtype/CommodityDetailtype').default)
    }, 'CommodityDetailtype');
};
export default(
    <Route path="/" component={App}>
        ...
        <Route path="type">
            <Route path="list" getComponent={CommodityListtype}/>
            <Route path="detail/:code" getComponent={CommodityDetailtype}/>
        </Route>
