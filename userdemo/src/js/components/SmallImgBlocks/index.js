                ...
                <Flex wrap="wrap" justify="between">
                    {
                        imgsData.length ? imgsData.map((imgData, index) => (
                            <SmallImgBlock index={index} handleSignInClick={handleSignInClick} key={"small"+index} pathUrl={imgData.url} imgUrl={imgData.pic} imgName={imgData.name} imgCode={imgData.code}/>
                        )) : ""
                    }
                </Flex>
                {/* </div> */}
