...
public class BannerAOImpl implements IBannerAO {
	...
	public List<Banner> queryBannerList(Banner banner) {
		return bannerBO.queryBannerList(banner);
	}

	@Override
	public Paginable<Banner> queryMallBannerPage(int start, int limit, Banner condition) {
		Paginable<Banner> page = null;
		page = bannerBO.getPaginable(start, limit, condition);
		return page ;
	}
