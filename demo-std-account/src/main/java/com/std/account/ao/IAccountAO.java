...
public interface IAccountAO {
     ...
     * @param bizNote
     */
    public XN002512Res transAmountYu(String fromAccountNo,String toAccountNo, String channelType,
             String transAmount, String bizType,
            String bizNote,String payGroup);
}
